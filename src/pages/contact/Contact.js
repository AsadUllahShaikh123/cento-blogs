    ...
    <div className="contact min-h-screen w-full " style={{backgroundColor:`${black?'#1A202C':'rgb(243 244 246)'}`,border:'1px solid transparent'}}>
       ...
       <div className="contact-container mx-3 md:mx-36 flex justify-between py-8 md:py-16">
          ...
          <div className="connect-section md:w-4/6 w-full " >
            <h1 className=' text-2xl md:text-5xl font-black mb-4' style={{color:`${black ? 'rgb(237, 242, 247)':'rgb(55 65 81)'}`}}>Let's Connect</h1>
            <p
             className='text-base md:text-xl'
             style={{color:`${black ? 'rgb(237, 242, 247)':'rgb(113,128,150)'}`,lineHeight:'36px'}}>FlexiBlog theme comes with a pre-made contact form component. You can integrate this form with serverless services such as Formspree, Getform, FormKeep and others to receive form submissions via email.</p>
          ...
          {/* Side Bar */}
          <div className="sider-bar md:block hidden px-12" style={{width:'35%',fontSize:'1.5rem',fontWeight:'700',color:`${black ? ' rgb(226, 232, 240)':'rgb(113, 128, 150)'}`}}>
            <h1 className='text-center' style={{marginBottom:'3.5rem'}}>Our Commitment </h1>
            <div className="box1" style={{backgroundColor:`${black?'rgb(45, 55, 72)':'white'}`,fontWeight:'400',fontSize:'1rem',borderRadius:'8px',padding:'32px',lineHeight:'28px'}}>
                  <p style={{color:`${black ? 'rgb(203, 213, 224)':'rgb(113, 128, 150)'}`}}>We take our commitment to our users seriously. If you need our help with your project, have questions about how to use the site or are experiencing any technical difficulties, please do not hesitate to contact us.</p>
            </div>
            <h1 className='text-center' style={{margin:'3.5rem 0'}}>Advertise With Us</h1>
            <div className="box1" style={{backgroundColor:`${black?'rgb(45, 55, 72)':'white'}`,fontWeight:'400',fontSize:'1rem',borderRadius:'8px',padding:'32px',lineHeight:'28px'}}
            >
                  <p style={{minWidth:'0',marginBottom:'1rem',color:`${black ? 'rgb(203, 213, 224)':'white'}`}}>Interesting in working together?</p>
                  <p style={{marginBottom:'1rem'}}>Suspendisse potenti. Mauris mollis diam tempus ut.</p>
                  <ul className="links-logo ">
                      {
                        icons.map(value => 
                        <li className=''> <i className={`${value.icon} hover:bg-blue-500 hover:text-white text-2xl rounded-full px-2 ` } style={{color:`${black?'rgb(113, 128, 150)':'black'}`}} /> {value.value}</li>
                        ) 
                      }
                  </ul>
            </div>
