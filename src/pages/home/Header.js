    ...
    <>
      ...
      >
          ...
          <div className="content flex flex-auto items-center justify-between md:py-8 py-5">
            ...
            <div className="toggle-button hidden md:block  ">
              <button
                ...
                className={`${
                  mode ? "light" : "dark flex-row-reverse"
                } ml-2 px-1 text-white flex justify-between items-center`}
              >
                <span
                  style={{
                    width: "21px",
        ...
        <div
          ...
          }  top-0 md:hidden w-full h-screen z-50`}
        >
          <div className="sidebar flex h-full">
            <div className="cross w-1/3 bg-black opacity-90 text-white h-full">
              <div className="p-8">
                <button
                  className="text-2xl font-bold px-4 py-2 text-gray-200 rounded-full"
            ...
            <div
              className="side-menubar w-2/3 h-full text-white"
              style={{ backgroundColor: "rgb(45, 55, 72)" }}
            >
              <div className="p-12">
                ...
                <ul>
                  ...
                  <li className="my-4 text-xl" onClick={() => handleRoute("/contact")}>
                    Contact
                  </li>
                  <li className="my-4 text-xl" onClick={() => handleRoute("/team")}>
                    Team
                  </li>
                </ul>
              </div>
