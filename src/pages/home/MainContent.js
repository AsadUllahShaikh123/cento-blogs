...
const MainContent = () => {
  ...
  return (
    <>
      <div className="main-content my-8">
        <div className="main-content-container w-1140 ml-auto mr-auto px-4">
          <div className="main-content-content flex ">
            ...
            <div className="slider-blogs" style={{width:'75%'}}>

              {/* Slider Portion  */}
              <div
                className="slider w-full relative"
                style={{
                  height: "400px",
              ...
              <div className="blogs-section flex justify-between w-full flex-wrap">
                {
                  advertise.map(value => 
                    <div className="w-1/2">
                      <Card category={value.category} articleHeading={value.articleHeading} author={value.author} date={value.date} read={value.read} image ={value.image} />
                    </div>)
                }
              </div>
            </div>
            ...
            {/* Side Bar Portion  */}
            <div className="side-bar" style={{backgroundColor:'rgb(237, 242, 247)',marginLeft:'16px',height:'100%',width:'253px',borderRadius:'8px'}}>
                <div style={{padding:'32px'}}>
                    ...
                    <a href="#learn" className="inline-flex items-center justify-between" style={{padding:'8px 16px',textAlign:'center',width:'10rem',borderWidth:'3px',borderStyle:'solid',borderRadius:'9999px',backgroundColor:'#667eea',color:'white',borderColor:'transparent',marginTop:'117px'}}>Learn More</a>
                </div>
            </div>
          </div>
        </div>
