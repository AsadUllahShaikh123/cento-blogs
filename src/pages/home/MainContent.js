      ...
      <div className="main-content mt-8">
        <div className="main-content-container w-1140 ml-auto mr-auto px-4">
          <div className="main-content-content flex ">
            ...
            {/* Side Bar Portion  */}
            <div className="side-bar hidden md:block" style={{backgroundColor:`${black ? 'rgb(45, 55, 72)':'rgb(237, 242, 247)'}`,marginLeft:'16px',height:'100%',width:'253px',borderRadius:'8px'}}>
