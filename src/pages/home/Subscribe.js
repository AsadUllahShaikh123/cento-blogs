...
const Subscribe = ({black}) => {
  return (
    <>
      <div className="subscribe-section">
        <div className="margin-top-container w-full  "></div>
        <div className="subscribe-container py-8 relative rounded-2xl  md:w-1140 w-full md:px-8 md:ml-auto md:mr-auto" style={{backgroundColor:`${black ? "rgb(45, 55, 72)":'white'}`}}>
          <div className="logo hidden md:block absolute -top-12 left-20">
            ...
            <svg
              ...
              width="1em"
              xmlns="http://www.w3.org/2000/svg"
              style={{ color:`${black ? 'rgb(113, 128, 150)': "#e2e8f0"}` }}
            >
